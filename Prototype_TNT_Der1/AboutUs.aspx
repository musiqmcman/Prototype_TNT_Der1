                ...
                <div id="about-us-slider" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
                            <div class="row">
                                <div class="col-md-6">
                                    <img class="img-responsive" src="img/team/dlamini.jpg" alt="" />
                                </div>
                                <div class="col-md-6">
                                    <div class="abt-slider-intro">
                                        <h3>Nkululeko Dlamini (Mobile App Developer)</h3>
                                        <p>
                                            Doing his 4th year of study in BEng Electrical Engineering & Inofrmation Technology. Hard Working, 
                                                    self-motivatedindividual who is a team player. Willing and able to work under pressure and
                                                    proactively share ideas on improving business and logical processes within the scope of the project.
                                        </p>

                                        <p>Languages familiar with are C#, C++, JAVA and CSS. Favourite IDE is Visual Studio.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="row">
                                <div class="col-md-6">
                                    <img class="img-responsive" src="img/team/SK.jpg" alt="" />
                                </div>
                                <div class="col-md-6">
                                    <div class="abt-slider-intro">
                                        <h3>Siphokuhle Mkhwanazi (Mobile App Developer)</h3>
                                        <p>
                                            Doing his 3rd year of study in BSc Inofrmation Technology. Hard Working, self-motivated 
                                        ...
                                        <p>Languages familiar with are C#, C++, JAVA and CSS. Favourite IDE is Android Studio.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="row">
                                <div class="col-md-6">
                                    <img class="img-responsive" src="img/team/Thato.jpg" alt="" />
                                </div>
                                <div class="col-md-6">
                                    <div class="abt-slider-intro">
                                        <h3><b>Thato Rampisi </b>(Web App Developer)</h3>
                                        <p>
                                            Doing his 3rd year of study in BSc Inofrmation Technology. Hard Working, self-motivated 
                                                    individual who is a team player. Willing and able to work under pressure and proactively 
                                                    share ideas on improving business and logical processes within the scope of the project.
                        ...
                        <div class="item">
                            <div class="row">
                                <div class="col-md-6">
                                    <img class="img-responsive" src="img/team/tumelo.jpg" alt="" />
                                </div>
                                <div class="col-md-6">
                                    <div class="abt-slider-intro">
                                        <h3><b>Tumelo Makwakwa</b> (Web App Developer)</h3>
                                        <p>
                                            Doing his 3rd year of study in BSc Inofrmation Technology. Hard Working, self-motivated 
                                                    individual who is a team player. Willing and able to work under pressure and proactively 
                                                    share ideas on improving business and logical processes within the scope of the project.
