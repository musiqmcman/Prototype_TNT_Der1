                ...
                <div class="event-html" style="width: 185%;">
                    ...
                    <div class="event-form" style="align-content:center">
                            ...
                            <asp:Table runat="server" CssClass="group">
                                <asp:TableRow>
                                    ...
                                    <asp:TableHeaderCell>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Required Field" ControlToValidate="txtEventName" CssClass="reqFieldValid">*</asp:RequiredFieldValidator>
                                    </asp:TableHeaderCell>
                                    <asp:TableCell>
                                    ...
                                    <asp:TableHeaderCell>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Required Field" ControlToValidate="txtStreet" CssClass="reqFieldValid">*</asp:RequiredFieldValidator>
                                    </asp:TableHeaderCell>
                                    <asp:TableCell>
                                ...
                                <asp:TableRow>
                                    ...
                                    <asp:TableHeaderCell>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator29" runat="server" ErrorMessage="Required Field" ControlToValidate="txtCategory" CssClass="reqFieldValid">*</asp:RequiredFieldValidator>
                                    </asp:TableHeaderCell>
                                    <asp:TableCell>
                                    ...
                                    <asp:TableHeaderCell>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Required Field" ControlToValidate="txtCity" CssClass="reqFieldValid">*</asp:RequiredFieldValidator>
                                    </asp:TableHeaderCell>
                                    <asp:TableCell>
                                ...
                                <asp:TableRow>
                                    <asp:TableHeaderCell>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Required Field" ControlToValidate="txtStart" CssClass="reqFieldValid">*</asp:RequiredFieldValidator>
                                    </asp:TableHeaderCell>
                                    <asp:TableCell>
                                        <asp:TextBox type="datetime2" ID="txtStart" runat="server" TextMode="DateTimeLocal" class="input" Height="35px" Width="280px"></asp:TextBox>
                                    </asp:TableCell>

                                    <asp:TableHeaderCell>
                                        <br /><label for="txtProvince" class="label">Province</label>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Required Field" ControlToValidate="txtProvince" CssClass="reqFieldValid">*</asp:RequiredFieldValidator>
                                    </asp:TableHeaderCell>
                                    <asp:TableCell>
                                ...
                                <asp:TableRow>
                                    <asp:TableHeaderCell>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Required Field" ControlToValidate="txtEnd" CssClass="reqFieldValid">*</asp:RequiredFieldValidator>
                                    </asp:TableHeaderCell>
                                    <asp:TableCell>
                                        <asp:TextBox type="datetime2" ID="txtEnd" runat="server" TextMode="DateTimeLocal" class="input" Height="35px" Width="280px"></asp:TextBox>
                                    </asp:TableCell>

                                    <asp:TableHeaderCell>
                                        <br /><label for="txtCountry" class="label">Country</label>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator30" runat="server" ErrorMessage="Required Field" ControlToValidate="txtCountry" CssClass="reqFieldValid">*</asp:RequiredFieldValidator>
                                    </asp:TableHeaderCell>
                                    <asp:TableCell>
                            ...
                            <asp:Table runat="server" CssClass="group">
                                <asp:TableRow>
                                    <asp:TableHeaderCell>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Required Field" ControlToValidate="txtDesc" CssClass="reqFieldValid">*</asp:RequiredFieldValidator>
                                    </asp:TableHeaderCell>
                                    <asp:TableCell>
                        ...
                        <div class="ticket-detail-htm">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in active" id="EarlyBird">
                                        <asp:Table runat="server" CssClass="group">
                                            ...
                                            <label for="txtE_OpenDate" class="label">Open Date</label>
                                                ...
                                                <asp:TableCell>
                                                    <asp:TextBox type = "datetime-local" TextMode ="DateTimeLocal" ID="txtE_OpenDate" runat="server" class="input" Height="45px" Width="350px"></asp:TextBox>
                                                    <br/>
                                               </asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                            ...
                                            <label for="txtE_ClosingDate" class="label">Closing Date</label>
                                                ...
                                                <asp:TableCell>
                                                    <asp:TextBox type = "datetime-local" TextMode ="DateTimeLocal" ID="txtE_ClosingDate" runat="server" class="input" Height="45px" Width="350px"></asp:TextBox>
                                              <br/>
                                                      </asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="VIP">
                                        <asp:Table runat="server" CssClass="group">
                                            ...
                                            <label for="txtV_OpenDate" class="label">Open Date</label>
                                                ...
                                                <asp:TableCell>
                                                    <asp:TextBox type = "datetime-local" TextMode ="DateTimeLocal" ID="txtV_OpenDate" runat="server" class="input" Height="45px" Width="350px"></asp:TextBox>
                                              <br/>
                                                      </asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                            ...
                                            <label for="txtV_ClosingDate" class="label">Closing Date</label>
                                                ...
                                                <asp:TableCell>
                                                    <asp:TextBox type = "datetime-local" TextMode ="DateTimeLocal" ID="txtV_ClosingDate" runat="server" class="input" Height="45px" Width="350px"></asp:TextBox>
                                              <br/>
                                                      </asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="VVIP">
                                        <asp:Table runat="server" CssClass="group">
                                            ...
                                            <label for="txtVV_OpenDate" class="label">Open Date</label>
                                                ...
                                                <asp:TableCell>
                                                    <asp:TextBox type = "datetime-local" TextMode ="DateTimeLocal" ID="txtVV_OpenDate" runat="server" class="input" Height="45px" Width="350px"></asp:TextBox>
                                              <br/>
                                                      </asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                            ...
                                            <label for="txtVV_ClosingDate" class="label">Closing Date</label>
                                                ...
                                                <asp:TableCell>
                                                    <asp:TextBox type = "datetime-local" TextMode ="DateTimeLocal" ID="txtVV_ClosingDate" runat="server" class="input" Height="45px" Width="350px"></asp:TextBox>
                                               <br/>
                                                     </asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="Regular">
                                        <asp:Table runat="server" CssClass="group">
                                            ...
                                            <label for="txtR_OpenDate" class="label">Open Date</label>
                                                ...
                                                <asp:TableCell>
                                                    <asp:TextBox type = "datetime-local" TextMode ="DateTimeLocal" ID="txtR_OpenDate" runat="server" class="input" Height="45px" Width="350px"></asp:TextBox>
                                                <br/>
                                                </asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                            ...
                                            <label for="txtR_ClosingDate" class="label">Closing Date</label>
                                                ...
                                                <asp:TableCell>
                                                    <asp:TextBox type = "datetime-local" TextMode ="DateTimeLocal" ID="txtR_ClosingDate" runat="server" class="input" Height="45px" Width="350px"></asp:TextBox>
                                               <br/>
                                                     </asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                            ...
                            <div class="foot-lnk">
                            <asp:Button Style="padding: 12px 100px;" class="btn btn-primary animated lightSpeedIn" ID="btnSubmit" runat="server" Text="Create Event" OnClick="btnSubmit_Click" />
                            </div>
                        </div>
                    </div>
                </div>
